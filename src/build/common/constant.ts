...
/** 客户端配置虚拟模块 ID */
export const VIRTUAL_CLIENT_CONFIG_ID = 'virtual:vita-site/runtime/config'

/** 客户端配置虚拟模块解析后的 ID */
export const RESOLVED_CLIENT_CONFIG_ID = '\0' + VIRTUAL_CLIENT_CONFIG_ID

/** 运行时进入虚拟模块 ID */
export const VIRTUAL_RUNTIME_ENTER_ID = 'virtual:vita-site/runtime/enter'
/** 运行时进入虚拟模块解析后的 ID */
...
/** 本地化配置虚拟模块 ID */
export const VIRTUAL_LOCALES_ID = 'virtual:vita-site/runtime/locales'
/** 本地化配置虚拟模块解析后的 ID */
export const RESOLVED_LOCALES_ID = '\0' + VIRTUAL_LOCALES_ID

/** 导航树虚拟模块 ID */
export const VIRTUAL_NAV_ID = 'virtual:vita-site/runtime/nav'
/** 导航树虚拟模块解析后的 ID */
export const RESOLVED_NAV_ID = '\0' + VIRTUAL_NAV_ID

/** 站点数据虚拟模块 ID */
export const VIRTUAL_SITE_DATA_ID = 'virtual:vita-site/runtime/site-data'
/** 站点数据虚拟模块解析后的 ID */
export const RESOLVED_SITE_DATA_ID = '\0' + VIRTUAL_SITE_DATA_ID

/** i18n 翻译消息虚拟模块 ID */
export const VIRTUAL_I18N_MESSAGES_ID = 'virtual:vita-site/runtime/i18n-messages'
